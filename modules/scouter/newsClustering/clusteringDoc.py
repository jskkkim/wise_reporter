...
class cluteringDoc():
    ...
    def runClus(self):
        ...
        '''
        for i in cent_num:
            for j in zip(df_data):
                if(i==cnt):
                    pre_cent_clus_doc.append(j['analyzed_text'])
                    cnt=0
                    break
                else:
                    cnt=cnt+1
        ...
        print(pre_cent_clus_doc[0])
        print(pre_cent_clus_doc[1])
        print(pre_cent_clus_doc[2])
        print(pre_cent_clus_doc[3])
        print(pre_cent_clus_doc[4])
